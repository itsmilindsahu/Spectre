...
│   └── nmr-extension.md
├── data/
│   ├── raw/                        # Downloaded JCAMP-DX spectra
│   ├── labeled/                    # Auto-labeled via SMARTS (see below)
│   └── README.md                   # Data sourcing + licensing notes
├── spectre/
│   ├── ingestion/                  # Parsers (JCAMP-DX, CSV)
│   ├── preprocessing/              # Baseline correction, interpolation
│   ├── features/                   # Peak picking, region binning
│   ├── models/
│   │   ├── rule_engine.py
│   │   ├── classical_ml.py
│   │   └── cnn.py
│   └── evaluation/                 # Benchmarking against known spectra
